...
R provides a number of ways to format dates values into human-friendly time strings.

(Dates class: integer days since some start date) and POSIX class (real number of seconds since some start time) 
